...
if __name__ == '__main__':
    ...
    student_1("информатика", 45, "test")
    student_1("математика", 90, "test")
    student_1("обж", 53, "test")
    student_1("обж", 5)
    student_1("информатика", 3)
    student_1("информатика", 47, "test")
    print(student_1)

    student_2 = Student("Александра", "Владимировна", "Ким", Path('lessons.csv'))
    student_2("русский язык", 4)
    student_2("история", 5)
    student_2("ивт", 4)
    student_2("математика", 5)
    student_2("ивт", 49, "test")
    student_2("обж", 86, "test")
    student_2("ивтя", 4)
